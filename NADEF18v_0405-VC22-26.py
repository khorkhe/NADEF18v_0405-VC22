...
PRINT_COPIES_PER_CLICK = 2  # با هر بار زدن دکمه PRINT، همین تعداد نسخه‌ی فیزیکی چاپ ارسال می‌شود


def print_text():
    """با هر بار زدن دکمه PRINT، PRINT_COPIES_PER_CLICK نسخه (پیش‌فرض 2) از همان
    لیبل به پرینتر انتخاب‌شده (COMECER_PRINTER_NAME) ارسال می‌شود.
