...
def comecer_handle_reading(reading):
    ...
    # --- جدول RAW + Activity: برای هر دو ظرف، همیشه و مستقل از dropdown ---
    ...
    # --- مسیر قبلی (دستی): همچنان برای خط Activity در لیبل پرینت، بر اساس چمبر
    # انتخاب‌شده در dropdown، به‌عنوان قابلیت جداگانه حفظ شده است ---
