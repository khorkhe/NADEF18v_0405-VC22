...
def clear_page_entries():
    ...
    مراکز، GBI، درصد کاهش و جمع‌ها) را پاک می‌کند. لیبل‌های ثابت نام مراکز
...
# دکمه‌های QC1 / QC2 — دقیقاً زیر ستون آخر (Next Dispense Time، column=7) که
...
frame_qc.grid(row=14, column=7, rowspan=2, pady=0)
